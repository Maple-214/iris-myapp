...
func main() {
	...
	booksAPI := app.Party("/v3/api")
	{
		...
		booksAPI.Get("/homePageContent", Api_floor)
...
type FloorProps2 struct {
	Title       string             `json:"title"`
	FloorSlides []SlidesFloorProps `json:"floorslides"`
}
type FloorProps struct {
	Floors []FloorProps2 `json:"floors"`
	...
	FloorProps2Data := []FloorProps2{
		{
			...
			FloorSlides: Floor1Props_Slides,
		},
	}
	Floor1_Data := FloorProps{
		Floors:          FloorProps2Data,
		Slides:          slides,
		Category:        category,
		LeaderImage:     "https://file.adquan.com/upload/20230512/1683882554110940.jpg",
		LeaderUrl:       "https://pub.dev/",
